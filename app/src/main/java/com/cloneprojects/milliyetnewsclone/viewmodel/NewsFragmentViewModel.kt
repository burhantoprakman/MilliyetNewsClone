...
import com.cloneprojects.milliyetnewsclone.repository.NewsRepository
...
////        )
    ...
    fun getNewsFeed() {
        val retroInstance = RetrofitInstance.getRetroInstance().create(NewsRepository::class.java)
